...
<img src="README_img/study_area.png" width="75%" height="75%" style="display:block;margin-left: auto;margin-right: auto;">

Let's see the comparison among Landsat Raw data, surface reflectance and the analyzed result (surface temperature).

<img src="README_img/Compare.PNG" width="95%" height="95%" style="display:block;margin-left: auto;margin-right: auto;">

## Result
The surface temperature changes during 1988-2018:

<img src="README_img/result.gif" width="50%" height="50%">

<img src="result_img/whole.png" width="45%" height="45%">
...
<img src="README_img/prompt.PNG" width="50%" height="50%">

The result will show up on the map as a layer as shown on the image below.

<img src="README_img/guide.png" width="85%" height="85%">
